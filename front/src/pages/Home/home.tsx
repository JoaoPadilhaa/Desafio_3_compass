...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className={styles.viewMore}>
        <div className={styles.classWhatsNew}><p>Hard to choose right products for your pets?</p>
        <h3>Our Products</h3></div>
        <div className={styles.buttonViewMore}><a href="#"><p>View More</p></a></div>
      </div>
      ...
      <div className={styles.viewMore}>
        <div className={styles.classWhatsNewI}>
          <p>Proud to be part of</p>
        <h3>Pet Sellers</h3></div>
        <div className={styles.buttonViewMoreI}><a href="#"><p>View all our sellers</p></a></div>
      </div>
      <div className={styles.petSellers}>
        <img src="/petsellers/sheba.png" />
        <img src="/petsellers/whiskas.png" />
        <img src="/petsellers/bakers.png" />
        <img src="/petsellers/felix.png" />
        <img src="/petsellers/goodboy.png" />
        <img src="/petsellers/butchers.png" />
        <img src="/petsellers/pedigree.png" />
      </div>

      <article className={styles.bannerI}>
        <div className={styles.contentBannerI}>
          <h2>Adoption <svg width="42" height="38" viewBox="0 0 42 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p>Adopt a pet and give it home,
              it will be love you back unconditionally.</p>
        </div>
        <div className={styles.buttonBannerI}>
          <a href="#" className={styles.buttonOneI}>
            <span>View Intro</span>
             </a>
          <a href="#" className={styles.buttonTwoI}>Explore Now</a>
        </div>
      </article>

      <div className={styles.viewMore}>
        <div className={styles.classWhatsNew}><p>You already know?</p>
        <h3>Useful Pet Knowledge</h3></div>
        <div className={styles.buttonViewMore}><a href="#"><p>View More</p></a></div>
      </div>
      ...
      <footer className={styles.footerFinale}>
        ...
        <div className={styles.linksAndContacts}>
          ...
          <div className={styles.socialLinks}>
              <a href="#" target="blank"><img src="imgs/facebook.jpg" /></a>
              <a href="#" target="blank"><img src="imgs/Twitter - Negative.jpg" /></a>
              <a href="#" target="blank"><img src="imgs/instagram.jpg" /></a>
              <a href="#" target="blank"><img src="imgs/youtube.jpg" /></a>
          </div>
        </div>
        <hr className={styles.linha} />

        <div className={styles.footerAgain}>
          <div className={styles.footerText}>
            <p>© 2025 Monito. All rights reserved</p>
          </div>

          <div className={styles.footerImg}>
            <img src="https://d1w7zrhxbqevdl.cloudfront.net/Monito-logo-complete.svg" />
          </div>
